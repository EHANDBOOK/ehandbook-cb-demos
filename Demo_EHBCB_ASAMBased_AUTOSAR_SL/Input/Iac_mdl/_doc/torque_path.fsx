	...
	<SW-SYSTEMS>
		<SW-SYSTEM>
			...
			<SW-COMPONENT-SPEC>
				<SW-COMPONENTS>
					<SW-FEATURE>
						<SHORT-NAME>TORQUE PATH Overview</SHORT-NAME>
						<LONG-NAME>
							<L-4 L="EN">Component Overview</L-4>
						</LONG-NAME>
						<CATEGORY>STC</CATEGORY>
						<CHAPTER>
							<SHORT-NAME>Graphical Overview</SHORT-NAME>
							<FIGURE>
								<FIGURE-CAPTION>
									<SHORT-NAME>Function Overview for Torque Path</SHORT-NAME>
                                </FIGURE-CAPTION>
								<L-GRAPHIC L="FOR-ALL">
