			...
			<SW-COMPONENT-SPEC>
				<SW-COMPONENTS>
					<SW-FEATURE>
						...
						<LONG-NAME>
							<L-4 L="EN">Sensor Value Treatment</L-4>
						</LONG-NAME>
						...
						<CHAPTER>
							...
							<FIGURE>
								<FIGURE-CAPTION>
									<SHORT-NAME>Sensors.Sensors_mdl</SHORT-NAME>
									<LONG-NAME>
										<L-4 L="DE">Komponentenübersicht der Sensorik der
											Motorsteuerung</L-4>
									</LONG-NAME>
								</FIGURE-CAPTION>
								<L-GRAPHIC L="FOR-ALL">
									<GRAPHIC NOTATION="EPS" SCALE="0.41">
									</GRAPHIC>
								</L-GRAPHIC>
							</FIGURE>
						</CHAPTER>
							...
							<CHAPTER>
								...
								<P>
									<L-1 L="DE">
										...
										Druckwerte durch die Anzahl gebildet, in Mpc_pManiFilt_Sim zur
							...
							<CHAPTER>
								...
								<P>
									<L-1 L="DE">
										...
										und in
										Bvc_uBatt_Sim als Nachricht zur Verfügung gestellt.
									</L-1>
								</P>
								<FIGURE>
									<FIGURE-CAPTION>
