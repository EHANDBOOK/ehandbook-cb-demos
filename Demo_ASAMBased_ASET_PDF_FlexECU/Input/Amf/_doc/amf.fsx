				...
				<SW-COMPONENTS>
					<SW-FEATURE>
						...
						<CHAPTER>
							...
							<FIGURE>
								<FIGURE-CAPTION>
									<SHORT-NAME>AirMassFlow.Main</SHORT-NAME>
								</FIGURE-CAPTION>
								<L-GRAPHIC L="FOR-ALL">
						...
						<CHAPTER>
							...
							<P>
								<L-1 L="DE">
									...
									Saugrohrdruck Mpc_pManiFilt
									und der Drehzahl Epm_rpmEngSpd die
									relative Füllung Amf_facRelAir und die Luftmasse
									pro Absaugung
									Amf_mAirPerStr berechnet und als Nachricht zur Verfügung
									gestellt.
									Die relative Füllung ist die Frischluftmasse im
									Zylinder unter den dort vorherrschenden
									Bedingungen relativ zur
									Frischluftmasse im selben Volumen unter Normbedingungen (Druck
									von 1013hPa,
							...
							<P>
								<L-1 L="DE">
									...
									Ctc_atCool (quasi
									Temperatur des Motorblocks) und der Frischluft Mtc_atMani
									gebildet,
