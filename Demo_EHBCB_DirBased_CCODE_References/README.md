...
4. `config_File`: `Demo_EHBCB_DirBased_CCODE_References/config_build_with_hierarchies.txt`
...
1. `Demo folder`:  
   `Demo_EHBCB_DirBased_CCODE_References/Input`

2. `Configuration file`:  
   `Demo_EHBCB_DirBased_CCODE_References/config_build_with_hierarchies.txt`
...
#### Demo Configuration File `config_build_with_hierarchies.txt`
...
-ccodemeta ".\configuration_without_hierarchies\CCodeConfig.xml"
```
#### Demo Configuration File `config_build_without_hierarchies.txt`
