				...
				<SW-COMPONENTS>
					<SW-FEATURE>
						...
						<CHAPTER>
							...
							<FIGURE>
								<FIGURE-CAPTION>
									<SHORT-NAME>Afr.Afr_mdl</SHORT-NAME>
								</FIGURE-CAPTION>
								<L-GRAPHIC L="FOR-ALL">
						...
						<CHAPTER>
							<SHORT-NAME>Luft-Kraftstoff-Verhältnis</SHORT-NAME>
							<LONG-NAME>
								<L-4 L="EN">Luft-Kraftstoff-Verhältnis</L-4>
							</LONG-NAME>
							<P>
								<L-1 L="DE">
									...
									und der relativen Füllung Amf_facRelAir_Sim ein Basiswert für
									Lambda
							...
							<P>
								<L-1 L="DE">
									...
									<TT TYPE="VARIABLE">Afr_facRatio_Sim</TT>
