				...
				<SW-COMPONENTS>
					<SW-FEATURE>
						...
						<CHAPTER>
							...
							<FIGURE>
								<FIGURE-CAPTION>
									<SHORT-NAME>Stc.Stc_mdl</SHORT-NAME>
									<LONG-NAME>
										<L-4 L="DE">
										</L-4>
									</LONG-NAME>
						...
						<CHAPTER>
							...
							<FIGURE>
								<FIGURE-CAPTION>
									<SHORT-NAME>stc_mdl_teil1.svg</SHORT-NAME>
									<LONG-NAME>
										<L-4 L="DE">
							...
							<P>
								<L-1 L="DE">
									...
									<TT TYPE="VARIABLE">Stc_stStarter_Sim</TT>
									gesetzt.
						...
						<CHAPTER>
							...
							<FIGURE>
								<FIGURE-CAPTION>
									<SHORT-NAME>stc_mdl_teil2.svg</SHORT-NAME>
									<LONG-NAME>
										<L-4 L="DE">
							...
							<P>
								<L-1 L="DE">
									...
									Zeitabhängig (Stc_CatalyserHeatingTime_Sim) die
									jeweils
									parametrierte Soll-Leerlaufdrehzahl ausgegeben. Mittels des
									Parameters
									Stc_flgCatalyserHeating_Sim wird die übliche
							...
							<P>
								<L-1 L="DE">
									...
									<TT TYPE="VARIABLE">Stc_CatalyserHeatingTime_Sim</TT>
									) wird über das
									Kennfeld
