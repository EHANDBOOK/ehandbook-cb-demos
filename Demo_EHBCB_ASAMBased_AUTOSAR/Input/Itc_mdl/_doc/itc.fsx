				...
				<SW-COMPONENTS>
					<SW-FEATURE>
						...
						<CHAPTER>
							...
							<FIGURE>
								<FIGURE-CAPTION>
									<SHORT-NAME>Itc.Itc_mdl</SHORT-NAME>
								</FIGURE-CAPTION>
								<L-GRAPHIC L="FOR-ALL">
						...
						<CHAPTER>
							...
							<P>
								<L-1 L="DE">
									...
									<TT TYPE="PRM">Fmc_mFuel_Sim</TT>
									in die Ein-
									-spritzzeit Itc_tiInj_Sim gewandelt, evaluiert, ob
									eine Einspritzung
									<TT TYPE="VARIABLE">Itc_flgInjCutoff_Sim</TT>
									= true
									stattfinden muss und die batteriespannungsabhängige
									Verzugszeit
									<TT TYPE="VARIABLE">Itc_tiBattDelay_Sim</TT>
									der
							...
							<P>
								<L-1 L="DE">
									...
									nung
									<TT TYPE="VARIABLE">Bvc_uBatt_Sim</TT>
									über die Kennlinie
