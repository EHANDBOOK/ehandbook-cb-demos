				...
				<SW-COMPONENTS>
					<SW-FEATURE>
						...
						<CHAPTER>
							...
							<FIGURE>
								<FIGURE-CAPTION>
									<SHORT-NAME>Dummy.Main</SHORT-NAME>
									<LONG-NAME>
										<L-4 L="DE">
										</L-4>
									</LONG-NAME>
						...
						<CHAPTER>
							...
							<P>
								<L-1 L="DE">
									...
									dummy_facThrValveReq an die Drosselklappe
									entspricht eins zu
									eins der Position des Egas-Stellers Egc_facEgas. Im Regelfall
									kommt
									diese Stellgröße aus der Funktion Momentenumrechnung
									(T2t_facThrValveReq).
								</L-1>
							</P>
							<P>
