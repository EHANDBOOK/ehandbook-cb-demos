				...
				<SW-COMPONENTS>
					<SW-FEATURE>
						...
						<CHAPTER>
							...
							<FIGURE>
								<FIGURE-CAPTION>
									<SHORT-NAME>Actuators.Actuators_mdl</SHORT-NAME>
									<LONG-NAME>
										<L-4 L="DE">
								...
								<L-GRAPHIC L="FOR-ALL">
									<GRAPHIC NOTATION="SVG" SCALE="0.31">
									</GRAPHIC>
								</L-GRAPHIC>
							</FIGURE>
						</CHAPTER>
						<CHAPTER>
							...
							<CHAPTER>
								...
								<P>
									<L-1 L="DE">
										Das Modul Drosselklappe (ThrottleValve) regelt die Position
										der Drosselklappe. Dazu
										...
										<TT TYPE="PRM">dummy_facThrValveReq_Sim</TT>
										begrenzt, um zu verhindern, dass eine nicht erreichbare
										Position eingeregelt werden soll, was zu einer Beschädigung
										führen kann, da der Stellwert
										für den Motor bis zum Maximum
										erhöht wird.
									</L-1>
								</P>
								<P>
							...
							<CHAPTER>
								...
								<P>
									<L-1 L="DE">
										...
										Sonst wird je nach Nachricht Itc_flgInjCutoff_Sim eine
										Abschaltung durchgeführt.
										Durch Setzen des Flags
										Ivc_flgInjCutoffOverride kann die Einspritzung manuell durch
										Ivc_flgInjCutoffMan an- und abgeschaltet werden.
									</L-1>
								</P>
								<P>
									<L-1 L="DE">
							...
							<CHAPTER>
								...
								<P>
									<L-1 L="DE">
										...
										jeder Wert im Feld
										Icc_degIgn_Arr wird mit Iac_degIgn_Sim beschrieben. Durch
										setzen des
										Flags Icc_flgIgnAngleOverride kann der Zündwinkel
										manuell mittels der Variablen
							...
							<CHAPTER>
								...
								<P>
									<L-1 L="DE">
										...
										Ctc_atCool_Sim, über einen Hystereseschalter, an- und
										ausgeschaltet.
										Durch setzen des Flags
