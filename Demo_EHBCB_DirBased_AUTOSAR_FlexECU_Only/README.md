...
1. `Demo folder`:  
   `Demo_EHBCB_DirBased_AUTOSAR_FlexECU_Only/Input`

2. `Configuration file`:  
   `Demo_EHBCB_DirBased_AUTOSAR_FlexECU_Only/config.txt`
...
#### Demo Configuration File (This is for demo build process "Convert AUTOSAR ARXML to EHB-CB Input Format")
