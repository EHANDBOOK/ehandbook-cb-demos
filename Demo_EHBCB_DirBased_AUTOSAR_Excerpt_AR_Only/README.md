...
4. `config_File`: `Demo_EHBCB_DirBased_AUTOSAR_Excerpt_AR_Only/config.txt`
...
1. `Demo folder`:  
   `Demo_EHBCB_DirBased_AUTOSAR_Excerpt_AR_Only/Input`

2. `Configuration file`:  
   `Demo_EHBCB_DirBased_AUTOSAR_Excerpt_AR_Only/config.txt`
