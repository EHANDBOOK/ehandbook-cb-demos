...
4. `config_File`: `Demo_EHBCB_DirBased_ASCET_SL_CCODE_Mixed/config.txt`
...
1. `Demo folder`:  
   `Demo_EHBCB_DirBased_ASCET_SL_CCODE_Mixed/Input`

2. `Configuration file`:  
   `Demo_EHBCB_DirBased_ASCET_SL_CCODE_Mixed/config.txt`
