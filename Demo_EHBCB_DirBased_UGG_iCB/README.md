...
1. `Demo folder`:  
   `Demo_EHBCB_DirBased_UGG_iCB/Input`

2. `Configuration file`:  
   `Demo_EHBCB_DirBased_UGG_iCB/config_step2_build_with_iCB.txt`
...
#### Demo Configuration File `config_step1_build_with_UGG.txt`
...
#### Demo Configuration File `config_step2_build_with_iCB.txt`
