				...
				<SW-COMPONENTS>
					<SW-FEATURE>
						...
						<CHAPTER>
							...
							<FIGURE>
								<FIGURE-CAPTION>
									<SHORT-NAME>IdleSpeedController.Main</SHORT-NAME>
									<LONG-NAME>
										<L-4 L="DE">
										</L-4>
									</LONG-NAME>
						...
						<CHAPTER>
							...
							<CHAPTER>
								...
								<P>
									<L-1 L="DE">
										...
										(Stc_flgStarterActive = true) oder manuell über
										das Label
								...
								<FIGURE>
									<FIGURE-CAPTION>
										<SHORT-NAME>isc_png_3</SHORT-NAME>
										<LONG-NAME>
											<L-4 L="DE">
								...
								<FIGURE>
									<FIGURE-CAPTION>
										<SHORT-NAME>isc_png_4</SHORT-NAME>
										<LONG-NAME>
											<L-4 L="DE">
								...
								<P>
									<L-1 L="DE">
										Der P-Anteil (
										<TT TYPE="VARIABLE">Isc_IdleSpdCtrlPPart</TT>
										) entspricht dem aus
										<TT TYPE="PRM">Isc_facPPart_CUR</TT>
										gebildeten Verstärkungsfaktor. Beim I-Anteil (
										<TT TYPE="VARIABLE">Isc_IdleSpdCtrlIPart</TT>
										) wird der
										Verstärkungsfaktor
										...
										Delta T des Integrators wird auf
										0,01s gesetzt, da diese Funktion
										im 10ms Raster ausgeführt
										wird.
									</L-1>
								</P>
								<P>
									<L-1 L="DE">
										...
										<TT TYPE="VARIABLE">Isc_facIdleSpdStab</TT>
										, der auf
								...
								<FIGURE>
									<FIGURE-CAPTION>
										<SHORT-NAME>Integrator.Main</SHORT-NAME>
										<LONG-NAME>
											<L-4 L="DE">
												Integrator
											</L-4>
							...
							<CHAPTER>
								...
								<FIGURE>
									<FIGURE-CAPTION>
										<SHORT-NAME>isc_png_8</SHORT-NAME>
										<LONG-NAME>
											<L-4 L="DE">
									...
									<ITEM>
										<P>
											<L-1 L="DE">Drehzahl über der Schwellendrehzahl des
												Leerlaufreglers(Isc_rpmIdleCtrlActivMax)
											</L-1>
										</P>
									</ITEM>
									<ITEM>
								...
								<P>
									<L-1 L="DE">
										...
										<TT TYPE="VARIABLE">Isc_flgFuelCutoff</TT>
										auf "true" gesetzt.
									</L-1>
								</P>
								<P>
